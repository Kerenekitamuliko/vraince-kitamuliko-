...
<head>
    ...
    <link rel="icon" href="#">
    <title>Kitamuliko Kerene Vraince</title>
    <!-- Bootstrap core CSS -->
									      ...
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/'.$r['image'].'">
																<div class="distance"><i class="fa fa-pin"></i>20/bcc/bu/r/0002</div>
															...
															<div class="content">
																...
																<div class="price-btn-block"><div class="bottom-part">
                                                                        <div class="cost"><i class="fa fa-check"></i> Min $ 10,00</div>
                                                                        <div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Bugema University Small Gate Restaurant</p>
                            <h5>Phone: <a href="tel:+256704923820">+256704923820</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>An Open SOurce Software Work with Mr Mugerwa Joseph (Lecturer)</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
